...
const data = {
  subTitle: 'S.A.N.TEAM',
  title: 'Відео-знайомство з нами',
  features: [
    {
      id: 1,
      altText: 'Kids',
      title: 'Тицяй на кнопку плей!',
      text:
        'Та переглянь відео про наших учнів, тренерів, та як створювалася наша тенісна школа.',
    },
  ],
};
...
export default function ServiceSection() {
  ...
  return (
    <section sx={{ variant: 'section.services'}} id="videosection">
